...
const paginationStyle = {
  ...
  paginationLink: {
    ...
    "&:hover,&:focus": {
      zIndex: "3",
      backgroundColor: "rgba(17, 17, 17, 0.21)",
      borderColor: "rgba(17, 17, 17, 0.21)"
    },
    "&:hover": {
      cursor: "pointer"
    }
  ...
  default: {
    "&,&:hover,&:focus": {
      ...
      color: "#FFFFFF",
      boxShadow:
        "0 4px 5px 0 rgba(59, 62, 62, 0.20), 0 1px 10px 0 rgba(251, 251, 251, 0.1), 0 2px 4px -1px rgba(251, 251, 251, 0.1)"
    },
    "&:hover,&:focus": {
      zIndex: "2",
      cursor: "default"
